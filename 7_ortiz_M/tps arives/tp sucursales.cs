    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < sucursales.Length; i++)
            {
                ...
                Console.Write("Ingrese la nota de la sucursal 1: ");
                ...
                for (int a = 0; a < 1; a++)
                {
                    Console.Write("Ingrese la nota de la sucursal 2: ");
            ...
            {
                Console.WriteLine("recaudo mas la sucursal 1");
            }

           else
            {
                Console.WriteLine("recaudo mas la sucursal 2");
            }
